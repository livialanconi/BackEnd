/*Faça um programa que pergunte para o usuário a quantidade de números
que ele quer digitar. Após isso crie um laço que exiba o número que o usuário
digitar apenas se for PAR. Utilize a estrutura WHILE.*/
    ...
    while (n <= q)
{
    ...
    {
        Console.WriteLine($"O número digitado é par: {i}");
    }
